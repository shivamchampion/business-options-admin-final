...
/**
 * Industry objects for hierarchical classification
 */
...
export interface CategoryObject extends IndustryObject {
  industryId: string;
  industryRef?: any; // DocumentReference
}

export interface SubCategoryObject extends CategoryObject {
  categoryId: string;
  categoryRef?: any; // DocumentReference
}
...
export interface ListingFilters {
  ...
  category?: string;
  subCategories?: string[];
  industries?: string[]; // Legacy field for backward compatibility
  location?: {
    country?: string;
    state?: string;
    city?: string;
